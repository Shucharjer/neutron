...
static void test_insert_erase_assign() {
    ...
    v.insert(
        static_cast<small_vector<int, 4>::const_iterator>(v.begin()),
        42); // [42,0,1,2,3,4]
    require(v.size() == 6);
    require(v.front() == 42);
    ...
    v.insert(
        static_cast<small_vector<int, 4>::const_iterator>(v.begin() + 3), 2,
        7); // [42,0,1,7,7,2,3,4]
    require(v.size() == 8);
    require(v[3] == 7 && v[4] == 7);
    ...
    int more[3] = { 9, 8, 6 };
    v.insert(
        static_cast<small_vector<int, 4>::const_iterator>(v.end()), std::begin(more),
        std::end(more));
    require(v.size() == 11);
    require(v.back() == 6);
    ...
    v.insert(
        static_cast<small_vector<int, 4>::const_iterator>(v.begin() + 2), { 1, 1, 1 });
    require(v.size() == 14);
    ...
    // erase range
    auto it = v.erase(
        static_cast<small_vector<int, 4>::const_iterator>(v.begin() + 1),
        static_cast<small_vector<int, 4>::const_iterator>(v.begin() + 4));
